...
from clinical.models import Study, Site, Subject, Form, Interval, Variable, Visit, Record, Coding, Query, RecordRevision
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            type=int,
            default=30,
            help='Number of days after which deleted items are permanently purged'
        )
    ...
    def handle(self, *args, **options):
        ...
        # or we can just let CASCADE handle it and count. But Django's queryset.delete() returns the number of deleted items.
