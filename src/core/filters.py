...
class SubjectFilter(FilterSchema):
    ...
    status: Annotated[str | None, FilterLookup(q="subject_status")] = None
...
class RecordFilter(FilterSchema):
    record_id: Annotated[str | None, FilterLookup(q="imednet_id")] = Field(None, alias="recordId")
    study_id: Annotated[int | None, FilterLookup(q="study_id")] = Field(None, alias="studyId")
