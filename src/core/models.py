...
class Job(SyncedResourceBase):
    ...
    state = models.CharField(max_length=100, help_text="The current state of the job.")
    date_created = models.DateTimeField(help_text="Date the job was created in iMednet.")
    date_started = models.DateTimeField(null=True, blank=True, help_text="Date the job started in iMednet.")
    date_finished = models.DateTimeField(null=True, blank=True, help_text="Date the job finished in iMednet.")
